    ...
    public void processRequest(Request request) {
        ...
        try {
            ...
            case OpCode.exists: {
                ...
                //反序列化客户端的 ExistsRequest（客户端传递过来的对象）
                ...
                //得到stat信息
                //ServerCnxn  (针对于每一个客户端连接，都会生成一个新的NIOServerCnxn对象实例)
        ...
        try {
            ...
            if (path == null || rsp == null) {
                ...
                switch (opCode) {
                    ...
                    default:
                        //stat信息包装的ExistResponse 通过ServerCnxn写回到客户端
                        cnxn.sendResponse(hdr, rsp, "response");
                }
            }
